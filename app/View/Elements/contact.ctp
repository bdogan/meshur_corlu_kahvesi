<div class="container">
  <div class="row">
    <div class="col-md-5">
      ...
      <a href="mailto:info@meshurcorlukahvesi.com"> info@meshurcorlukahvesi.com</a><br><br>
      ...
      <p>
        ...
        <a href="http://www.trakyalezzetleri59.com" target="new" class="btn btn-success"><i class="fa fa-shopping-cart" style="font-size: 20px;margin-right: 4px;margin-left: -2px;vertical-align: -2px;"></i> trakyalezzetleri59.com</a>
      </p>
    </div>
    <div class="col-md-6">
